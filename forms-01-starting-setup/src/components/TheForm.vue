<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{'invaild': userNameValidity === 'invaild'}">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validateInput"/>
      <p v-if="userNameValidity === 'invaild'">Please enter a valid name!</p>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="userAge" ref="ageUser" />
    </div>
    <div class="form-control">
...
export default {
    ...
    methods: {
        ...
        validateInput() {
            this.userNameValidity = "vaild";
            if (this.userName === "") {
                this.userNameValidity = "invaild";
            }
        }
    },
